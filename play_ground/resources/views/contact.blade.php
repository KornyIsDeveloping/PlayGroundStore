<x-layout>
    <x-slot:heading>
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Contact Play Ground Store</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">Something will be here</p>
        </div>df
        <form action="#" method="Pgdhfte-x-0" -->
