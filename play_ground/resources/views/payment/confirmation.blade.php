    ...
    <div class="max-w-2xl mx-auto p-6 dark:bg-gray-800 shadow-md rounded-lg">
        ...
        <form action="{{ route('payment.process') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="card-number" name="card_number" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="1234 5678 9012 3456" required>
            </div>
