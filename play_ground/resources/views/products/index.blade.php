    ...
    <main>
        <div class="flex">
            <form class="max-w-md mb-10 mr-auto flex-1" method="GET" action="{{ route('products.index') }}">
                @csrf
                <select name="genre" class="block w-full text-custom-dark-text dark:bg-gray-800 p-3 text-sm border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
