    ...
    <main>
        <div class="flex">
            <form class="max-w-md mb-10 mr-auto flex-1" method="GET" action="{{ route('products.index') }}">
                @csrf
                <select name="genre" class="block w-full dark:bg-gray-800 p-3 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
            ...
            <form class="max-w-md mb-10 ml-auto flex-1">
                ...
                <div class="relative flex justify-end">
                    ...
                    <input value="{{ request()->get('name') ?? '' }}" type="search" id="default-search" name="name" class="block w-full dark:bg-gray-800 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for a game..." />
