        ...
        <div class="flex">
            <form class="max-w-md mb-10 mr-auto flex-1" method="GET" action="{{ route('products.index') }}">
                ...
                <div class="flex">
                    <div class="flex-none w-80">
                        <select name="genre" class="block w-full text-custom-dark-text dark:bg-gray-800 p-4 text-sm border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="flex-none w-80 ml-5">
                        <button type="submit" class="mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Filter</button>
                    </div>
                </div>
            </form>
            <form class="max-w-md mb-10 ml-auto flex-1">
                ...
                <div class="relative flex justify-end">
                    ...
                    <input value="{{ request()->get('name') ?? '' }}" type="search" id="default-search" name="name" class="block w-full text-custom-dark-text dark:bg-gray-800 p-4 ps-10 text-sm border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for a game..." />
            ...
            @foreach($products as $product)
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="{{ route('products.show', $product->id) }}">
                            <img class="rounded-t-lg w-full object-cover object-center h-[500px]" src="{{ asset('storage/images/' . $product->image) }}" alt="{{ $product->name }}">
                    </a>
                    <div class="p-5">
                        <a href="#">
